...
public class RecyclerViewAdapterTextTutorial extends RecyclerView.Adapter<RecyclerViewAdapterTextTutorial.RecyclerViewHolderTutorial> {

    private ArrayList<TextTutorialItem> itemList;
    private Context context;
    private FragmentManager fragmentManager;

    public RecyclerViewAdapterTextTutorial(Context context, ArrayList<TextTutorialItem> itemList, FragmentManager fragmentManager) {
    ...
    @Override
    public RecyclerViewAdapterTextTutorial.RecyclerViewHolderTutorial onCreateViewHolder(ViewGroup parent, int viewType) {

        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_list_video_tutorial, parent, false);
        RecyclerViewAdapterTextTutorial.RecyclerViewHolderTutorial rcv = new RecyclerViewAdapterTextTutorial.RecyclerViewHolderTutorial(layoutView, fragmentManager);
        return rcv;
    }

    @Override
    public void onBindViewHolder(RecyclerViewAdapterTextTutorial.RecyclerViewHolderTutorial holder, int position) {
